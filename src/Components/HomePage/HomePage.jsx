    ...
    return (
        <>
            <Box bg={"rgba(22,34,57,0.85)"} minH={"calc(100vh - 100px)"} flexDir={"column"} display={"flex"} alignItems={"center"}>
                <Box minH={"calc(70vh - 170px)"} display={"flex"} flexDir={"column"} alignItems={"center"} justifyContent={"center"}>
                ...
                <Box minH={"350px"} w={"100%"} display={"flex"} justifyContent={"space-evenly"} alignItems={"flex-end"} flexDir={["column", "column", "column", "row"]}>
                    ...
                    <Box className={s.openBoxes} w={["100%", "100%", "100%", "45%"]} h={"150px"} bg={"#0c1228"}>
                        ...
                        <Text pb={"30px"} color={"white"}>As a subscribed member you will have the benefit of creating active 5000 short URLs with detailed link click analysis. The data can also be updated live inside a Google Sheet. You also will be able to customise the short URLs with your custom domain.</Text>
                    </Box>
                </Box>
            </Box>
            <Contact />
